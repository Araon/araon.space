        ...
        >
          ...
          <div className="flex w-fit max-w-md flex-col gap-1 md:max-w-sm">
            ...
            <p className="z-50 text-sm text-secondary">
              Creator based in India. Focuses on topics including computer
              science, calisthenics, engineering, design, and lifestyle.{" "}
              <Link href="" underline>
                Visit channel.
              </Link>
            </p>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            ...
            >
              ...
              <p className="text-sm text-secondary">Akiflow App · xk Views</p>
            </Link>
            <Link
              className="group col-span-1 flex flex-col no-underline"
              href=""
            ...
            >
              ...
              <p className="text-sm text-secondary">Ergonofis · x.xk Views</p>
            </Link>
            <Link
              className="group col-span-1 flex flex-col no-underline"
              href=""
