    ...
    <div className="mx-auto max-w-[700px] px-6 pb-24 pt-16 md:px-6 md:pb-44 md:pt-20">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-secondary border border-primary rounded-lg p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-brand text-white font-medium rounded-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 focus:ring-offset-primary disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
              {isLoading ? (
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-2 bg-tertiary rounded-md border border-secondary">
            <svg className="w-4 h-4 text-link" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
            </svg>
            <span className="text-xs text-secondary">
              Protected with bcrypt + rate limiting
            </span>
          </div>
          
          <p className="text-xs text-tertiary mt-3">
            Session expires after 8 hours • araon.space admin
          </p>
        </div>
      </div>
    </div>
